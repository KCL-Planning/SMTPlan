...
string parse_category::display() const
{int ind;
    TITLE(parse_category);
}
...
string control_symbol::display() const
{
    //TITLE(control);
    //LEAF(name);
    return name;
...
void control_symbol::visit(VisitController *v) const {v->visit_control_symbol(this);};
